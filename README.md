...
ISC² が提供する CCSP 認定試験に向けた学習をサポートするための対話型問題集です。200問の問題を含み、複数の学習モードが提供されています。

- **全問順番通り**: 200問を順序通りに解く
- **ランダム200問**: 200問をシャッフルして解く
...
4. **ドメイン4**: クラウドアプリケーションセキュリティ (34問)
5. **ドメイン5**: クラウドセキュリティオペレーション (32問)
6. **ドメイン6**: クラウドガバナンス、法務、リスク、コンプライアンス (26問)
